...
tags:
  ...
  - UI / UX
  - end to end
github_url: "https://self-statistics-system-v2.web.app/app/journal"
demo_url: "https://github.com/richardhcli/self-statistics-system-v2"
---

## Abstract: 
Complete end to end irl game status screen created using journal entry analysis. 
...
* Hosting: https://self-statistics-system-v2.web.app/app/journal (updated: v1 -> v2 to reduce load)
* Demo video: https://youtu.be/zvvyPhYOxqU 
* Devpost: https://devpost.com/software/incremental-system-irl-status-screen 
